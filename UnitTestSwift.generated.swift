...
class GeneratedTestsSwift: XCTestCase {
	...
	func testGenericStruct() {
		...
		let model = GenericStruct(
					genericvar: "testString(generic)"
		)
 

		XCTAssertEqual(model.genericvar, "testString(generic)")
		XCTAssertNotNil(model)
	}
	...
	func testTeststructModel() {
		...
		let model = TeststructModel(
					...
					genericvar:  GenericStruct(genericvar: "testString(generic)")
		)
		...
		XCTAssertEqual(model.genericvar.genericvar, "testString(generic)")
